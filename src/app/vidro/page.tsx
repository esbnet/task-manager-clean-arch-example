...
function Vidro() {
	return (
		<div className="flex flex-col justify-between items-center bg-gradient-to-br from-blue-400 to-purple-600 p-6 min-h-screen">
			{/* Header com Animação */}
			...
			<main className="flex-1 bg-white/20 opacity-0 shadow-xl backdrop-blur-md mb-6 p-8 rounded-xl w-full max-w-4xl text-white animate-[slideUp_1s_ease-in-out_forwards]">
